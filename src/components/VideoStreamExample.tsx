...
// Example data - AWS colleague will replace this with real API data
const mockVideoStreams: VideoStream[] = [
  {
    ...
    status: 'pending',
    videoFiles: {
      'NCBSC_front': '/videos/NCBSC_front.mp4',
      'TCBSC_back': '/videos/TCBSC_back.mp4',
      'TCMVC_back': '/videos/TCMVC_back.mp4',
      'NLBSC_left': '/videos/NLBSC_left.mp4',
      'NLMVC_back_left': '/videos/NLMVC_back_left.mp4',
      'NLMVC_front_left': '/videos/NLMVC_front_left.mp4',
      'NRBSC_right': '/videos/NRBSC_right.mp4',
      'NRMVC_back_right': '/videos/NRMVC_back_right.mp4',
      'NRMVC_front_right': '/videos/NRMVC_front_right.mp4',
      'WCNVC_front': '/videos/WCNVC_front.mp4',
      'WCWVC_front': '/videos/WCWVC_front.mp4',
    }
  },
  {
    id: 'stream_2',
